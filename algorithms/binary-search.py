...
# 普通二分查找
print(binary_search(l1, 22))
# 查找第一个等于给定值的元素
print(binary_search_1(l1, 22))
# 查找最后一个等于给定值的元素
print(binary_search_2(l1, 22))
# 查找第一个大于给定值的元素
print(binary_search_3(l1, 9))
# 查找最后一个小于给定值的元素
print(binary_search_4(l1, 9))
